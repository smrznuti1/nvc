...
vim.api.nvim_create_user_command("OilRemote", function(args)
  vim.fn.execute("Oil oil-ssh://" .. args.args:gsub(":", "/", 1))
end, { desc = "Open Remote File Using the notation: Host:Path", nargs = 1 })
