...
do
  ...
  --  See `:help 'clipboard'`
  vim.schedule(function() vim.o.clipboard = 'unnamedplus,unnamed' end)
...
do
  ...
  vim.api.nvim_create_autocmd('PackChanged', {
    callback = function(ev)
      ...
      if name == 'markdown-preview.nvim' and vim.fn.executable 'yarn' == 1 then
...
do
  ...
  -- friendly-snippets: variety of premade snippets
...
do
  ...
  -- Add your own plugins, configuration, etc from `lua/custom/plugins/*.lua`
